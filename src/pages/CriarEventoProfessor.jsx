          ...
          {menuOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg">
              <ul className="py-2">
                ...
                <li onClick={() => navigate("/dashboard-professor")} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
                  Meus Eventos
                </li>
      ...
      <div className="p-6 max-w-5xl mx-auto bg-white shadow-md rounded-lg">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-6">
          ...
          <div className="col-span-2 flex justify-between mt-6">
            <button onClick={() => navigate("/dashboard-professor")} className="bg-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-400">
              Cancelar
            </button>
